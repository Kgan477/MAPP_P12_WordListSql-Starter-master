...
public class WordListOpenHelper extends SQLiteOpenHelper {
    ...
    private void fillDatabaseWithData(SQLiteDatabase db) {
        ...
        String[] words = {"Android", "Adapter", "ListView", "AsyncTask", "Android Studio", "KennethGanKimYu","SQLiteDatabase", "SQLOpenHelper", "Data model", "ViewHolder","Android Performance", "OnClickListener"};
    ...
    public int update(int id, String word)
    {
        ...
        try
        {
            ...
            ContentValues values = new ContentValues(); values.put(KEY_WORD, word);
